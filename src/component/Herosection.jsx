...
{/* <div className="absolute inset-0 bg-black/40 bg-opacity-40 flex flex-col items-start justify-center p-4 text-center">
      ...
      <p className="text-black max-w-xl">{slide.subtitle}</p>
          ...
          <div className="custom-pagination flex space-x-4  " />
              ...
              <div className=''>
             <div className=" absolute bottom-16  md:bottom-[-40] left-[10rem] lg:left-[18.3rem] right transform -translate-x-1/2 z-20 bg-[#c26265] text-white py-4 lg:py-10  lg:space-y-4 pl-8 md:pl-0  rounded-md md:text-center lg:max-w-xl w-full shadow-lg">
